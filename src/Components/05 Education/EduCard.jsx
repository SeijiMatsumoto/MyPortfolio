...
import { CardContainer, Company, Position, Time, PosTime, Desc, DescLi } from './Styles/EduCard.style.js';
...
const EduCard = (props) => {
  ...
  const checkInView = () => {
    if (!shown) {
      const aboutEl = document.getElementById('edu' + props.i);
  ...
  return (
    <CardContainer id={'edu' + props.i}>
      <Company font={compFont} border={border}>{place}</Company>
      <PosTime>
