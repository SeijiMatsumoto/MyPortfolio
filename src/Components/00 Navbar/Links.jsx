  ...
  return (
    <div>
      ...
      <LinksUl>
        ...
        <Link id='resume'><Resume color={color}><ResumeDownload color={color} href='/SeijiMatsumotoResumeSept2021.pdf' download rel="noopener noreferrer" target='_blank'>Resume</ResumeDownload></Resume></Link>
      </LinksUl>
      : null }
    </div>
  );
