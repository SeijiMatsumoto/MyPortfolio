export const projects = [
  {
    title: '01. Jikan Pomodoro (WIP)',
    url: 'https://i.imgur.com/TnGUAao.jpg',
    description: 'Full-stack website designed to be a mobile-friendly customizable digital clock and pomodoro timer with a simple user interface. Pomodoro is a time-management technique with set intervals for work and for breaks. Built with Next.js for fast load times and optimization and with Typescript to catch errors or mistakes right away.',
    stack: ['React', 'Typescript', 'Next.js', 'Sass', 'Pexels API'],
    github: 'https://github.com/KSJ-Group/Jikan'
  },
  {
    title: '02. Restaurant Website (WIP)',
    url: 'https://i.imgur.com/kVP5LGh.png',
    description: 'Full-stack website created for a local ramen restaurant, Ramen Matsu, that is mobile-friendly and connects with the Square API that allows for placing orders through the website. The original website was created using Square\'s website builder, but was very limited in functionality and creative freedom. This website was created to solve those issues.',
    stack: ['Full-stack', 'React', 'Node.js', 'Express', 'Square API'],
    github: 'https://github.com/SeijiMatsumoto/RamenMatsu'
  },
  {
    title: '03. Helping Hands',
  ...
  {
    title: '05. Instagram Bot',
    url: 'https://i.imgur.com/mu0H6rX.png',
    description: 'A bot written in Python using Selenium, which is used to control HTML elements in a browser. This bot mimics real human interaction with other accounts and posts, with the goal of naturally gaining followers over time. The bot has increased my dog\'s Instagram following by over 1000 in just two months.',
    stack: ['Script', 'Python', 'Selenium'],
